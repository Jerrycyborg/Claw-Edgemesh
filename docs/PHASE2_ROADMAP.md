...
- Execute real task kinds safely with bounded timeouts (`shell`, `orchestrator-run`, `hook-dispatch`)
- Capture structured stdout/stderr and normalized error codes
- Enforce mandatory security test gate in orchestrator-run flow
